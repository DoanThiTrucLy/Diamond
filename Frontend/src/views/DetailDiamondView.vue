<template>
    <div class="detail-diamond-view" v-if="diamond !== null">
        <div class="container my-6 p-5">
            <div class="row">
                <section class="imgs col-lg-5">
                    <div style="border: 1px solid #333;">
                        <img :src="diamond.image[indexImgIntro].url" class="img--lg w-100">
                    </div>
                    <div class="d-flex justify-content-center mt-2">
                        <div class="img-item__wrapper w-25 mx-1" v-for="(img, index) in diamond.image" :key="index" @click="() => indexImgIntro = index">
                            <img class="w-100" :src="img.url" alt="anh">
                        </div>
                    </div>
                </section>

                <div class="col-lg-7 diamond-info-detail">
                    <div>
                        <h2>{{ diamond.name }}</h2>
                        <br />
                        ...
                        <div class="w-75">
                            <div class="d-flex mt-2">
                                <span class="w-25">Màu nước: </span>
                                <select class="w-75" style="flex: 3;">
                                    <option>{{ diamond.color }}</option>
                                </select>
                            </div>
                            <div class="d-flex  mt-2">
                                <span class="w-25">Độ tinh khiết: </span>
                                <select class="w-75">
                                    <option>{{ diamond.clarity }}</option>
                                </select>
                            </div>
                            <div class="d-flex  mt-2">
                                <span class="w-25">Lát cắt: </span>
                                <select class="w-75">
                            ...
                            <div class="d-flex  mt-4">
                                ...
                                <input style="max-width: 50px; justify-content: flex-start;" type="number" id="quantity-order" min="1" value="1">
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async assignValues() {
            const res = await diamondService.detailDiamond(this._id);
