<template>
    <div class="container mt-3 mb-3">
        ...
        <div class="row">
            ...
            <form method="POST" @submit.prevent="handleSignup" id="form-signup" class="form-col col-lg-6 ">
                <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" placeholder="email" v-model="formRegister.email">
                    <span class="form__msg"></span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address"
                        placeholder="Khu 2, Đ. 3/2, P. Xuân Khánh, Q. Ninh Kiều, TP. CT" v-model="formRegister.address">
                    <span class="form__msg"></span>
                </div>
                <button type="submit" class="btn btn-primary">Đăng ký</button>
                <br />
                <span style="font-style: italic;">Bạn đã có tài khoản? <router-link to="/auth/signin">đăng
    ...
    methods: {
        async handleSignup() {
            ...
            if (res.status == 201) {
                ...
                window.alert('Tai khoan da co, vui long dang nhap hoac dang ky tai khoan khac!!!!')
            }
        },
        handleValidator() {
            Validator({
